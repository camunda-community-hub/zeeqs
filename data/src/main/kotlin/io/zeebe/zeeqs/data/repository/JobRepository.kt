...
@Repository
interface JobRepository : PagingAndSortingRepository<Job, Long>, CrudRepository<Job, Long> {
    ...
    fun findByProcessInstanceKeyAndStateInAndJobTypeIn(
        processInstanceKey: Long,
        stateIn: List<JobState>,
        jobTypeIn: List<String>
    ): List<Job>
