...
a [new issue](https://github.com/camunda-community-hub/zeeqs/issues). Before creating an issue, make sure
...
a [new issue](https://github.com/camunda-community-hub/zeeqs/issues). Describe your idea and the
...
```
feat(graphql): query process instances by variable

* add query for process instance with a variable as criteria
* ...
```
